...
public class CangTest5 {
	...
	public static void init() {
		list.add(get("堕天", 1, 2, 1, 2, 0));
		list.add(get("统治", 1, 1, 0, 11, 6));
		list.add(get("死亡", 1, 0, 0, 7, 9));
		list.add(get("抵御", 0, 1, 2, 11, 11));
		list.add(get("恶魔", 1, 0, 1, 15, 8));
		list.add(get("宿命", 0, 0, 9, 14, 6));
		list.add(get("灼烧", 0, 0, 9, 21, 0));
		...
		list.add(get("天使", 1, 1, 0, 3, 1));
		list.add(get("王权", 1, 2, 5, 9, 1));
		list.add(get("安息", 1, 0, 0, 0, 7));
		list.add(get("守护", 0, 1, 4, 13, 11));
		list.add(get("魔鬼", 1, 0, 0, 4, 0));
		list.add(get("命运", 0, 0, 12, 13, 4));
		list.add(get("热诚", 0, 0, 11, 14, 0));
		list.add(get("圣杯", 0, 0, 1, 1, 0));
		list.add(get("冰霜", 0, 1, 0, 1, 0));
		list.add(get("审判", 0, 0, 1, 2, 0));
		list.add(get("正义", 0, 0, 1, 3, 0));
